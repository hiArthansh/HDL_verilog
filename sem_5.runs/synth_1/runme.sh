...
HD_PWD='C:/Users/armte/OneDrive/Desktop/verilog projects/vivado_projects/sem_5/sem_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prac1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prac1.tcl
